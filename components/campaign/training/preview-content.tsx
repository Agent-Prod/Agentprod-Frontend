...
function PreviewContent() {
  ...
  useEffect(() => {
    if (!user || previewType !== "previewFromAI" || channel === "Linkedin") return;
  ...
  const FollowUpSection = ({ number, loading, content }: {
    ...
    <Card className="p-4 space-y-3 border-muted">
      ...
      <Textarea
        className="min-h-[200px] text-sm leading-relaxed bg-background/50"
        value={content || ""}
        readOnly
      />
    </Card>
      ...
      <ResizablePanel defaultSize={70}>
        <div className="flex justify-center p-6">
          <div className="flex-col w-full max-w-3xl space-y-6">
            ...
            {campaignType !== "Nurturing" && channel !== "Linkedin" && (
              <div className="space-y-4">
                <h3 className="text-sm font-medium text-muted-foreground">Follow-up Sequence</h3>
                <FollowUpSection
                  number={1}
                  loading={load1}
