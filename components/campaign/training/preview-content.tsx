...
function PreviewContent() {
  ...
  const fetchFollowUpData = async () => {
    try {
      // Email follow-ups
      if (channel === "mail" || channel === "omni") {
        setLoad1(true);
        const response1 = await axiosInstance.post("/v2/training/autogenerate/followup", {
          user_id: user?.id,
          follow_up_number: 1,
        ...
        setLoad2(true);
        const response2 = await axiosInstance.post("/v2/training/autogenerate/followup", {
          user_id: user?.id,
          follow_up_number: 2,
          campaign_id: params.campaignId,
          previous_emails: [
    ...
    try {
      if (previewType === "previewFromTemplate") {
        ...
        if (channel === "omni") {
          ...
          console.log("linkedin message" + linkedinMessage)
              ...
              <>
                ...
                {campaignType !== "Nurturing" && (
                  <div className="space-y-4">
                    ...
                    <FollowUpSection
                      number={1}
                      loading={loadLinkedinFollow1}
                      content={linkedinFollowUp}
                    />
                    {channel === "Linkedin" && <FollowUpSection
                      number={2}
                      loading={loadLinkedinFollow2}
                      content={linkedinFollowUpTwo}
                    />}
                  </div>
                )}
              </>
