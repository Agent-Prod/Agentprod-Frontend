...
export default function Training() {
  ...
  const handleSendTestEmail = async () => {
    try {
      ...
      setTestLoading(true);
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_SERVER_URL}v2/google/test-brevo-email`,
        {
                ...
                <DialogContent className="max-w-4xl">
                  ...
                  <div className="mt-4 flex justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      {testLoading ? <LoadingCircle /> : <Button className="w-max whitespace-nowrap" onClick={handleSendTestEmail}>Send Email</Button>}
                    </div>
                    <Button onClick={handleStartCampaign}>
                      Start Campaign
                    </Button>
