...
export default function Training() {
  ...
  const [startCampaignIsLoading, setStartCampaignIsLoading] =
    ...
    const [customeEmailLoading,setCustomeEmailLoading] = React.useState(false)
        ...
        <div className="flex items-center flex-row">
          ...
          {startCampaignIsLoading ? (
            ...
            <Dialog>
              ...
              {testCampLoading ? null : (
                <DialogContent className="max-w-4xl">
                  ...
                  <div className="mb-4 flex flex-row pt-5 px-2 w-1/2">
            <Input
            className="w-2/3"
            ...
            onClick={async() => {
              ...
              if (newEmail) {
                const updatedTestCamp = [
                  ...testCamp,
                  {
                    seed_mail: newEmail,
                    receivedAt: '-', 
                    spam_score: '-', 
                    sender: testCamp[0].sender, 
                  },
                ];
                setTestCamp(updatedTestCamp); 
                setNewEmail(''); 
                setCustomeEmailLoading(false);
            ...
            >
                  {customeEmailLoading ? <LoadingCircle /> : "Send"}
                  </Button>
          </div>
                    <Button onClick={handleStartCampaign}>
                      Start Campaign
