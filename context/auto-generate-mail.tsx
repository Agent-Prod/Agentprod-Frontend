...
interface AutoGenerateContextType {
  ...
  setMessageAfterInvite: (messageAfterInvite: string) => void;
  linkedinFollowUp: string[];
  setLinkedinFollowUp: (linkedinFollowUp: string[]) => void;
}
...
export const AutoGenerateProvider = ({
  ...
  const [messageAfterInvite, setMessageAfterInvite] = useState<string>("");
